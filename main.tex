...
\pred{esCamino}{\In camino: \TLista{\ent}, \In desde: \ent, \In hasta: \ent, \In A: \TLista{\TLista{\ent}}}{
...
\pred{siCoincidenNombresSumoHabitantes}{\In res: \TLista{Ciudad}, \In men: \TLista{Ciudad}, \In may: \TLista{Ciudad}, \In i: \ent, \In j: \ent, \In k: \ent}{(res[i].nombre = men[j].nombre \; \wedge \;  res[i].nombre = may[k].nombre) \; \wedge \\ res[i].habitantes = men[j].habitantes + may[k].habitantes}
